  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${backendUrl}/api/delivery/create`, {
        ...
        discount,
        totalAmount,
        userId, // ✅ notification ke liye backend ko bhej rahe hain
      });
              ...
              <div className="border rounded-xl overflow-hidden">
                ...
                <label
                  className={`flex justify-between items-center p-4 cursor-pointer border-b ${
                    form.paymentMethod === "card" ? "bg-blue-50" : "hover:bg-gray-50"
                  }`}
                >
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <span>PayFast (Debit / Credit Card)</span>
                  </div>
